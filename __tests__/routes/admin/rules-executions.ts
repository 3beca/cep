...
describe('admin', () => {
    ...
    describe.only('rules-executions', () => {
        ...
        it('should return a list of rules executions', async () => {
            ...
            expect(ruleExecution1.skip).toBe(false);
            expect(ruleExecution1.executedAt).not.toBe(undefined);
            expect(ruleExecution1.targetId).toBe(target1.id);
            expect(ruleExecution1.targetName).toBe(target1.name);
            expect(ruleExecution1.targetSuccess).toBe(false);
            expect(ruleExecution1.targetStatusCode).toBe(500);
            ...
            expect(ruleExecution2.ruleId).toBe(rule2.id);
            expect(ruleExecution2.ruleName).toBe(rule2.name);
            expect(ruleExecution2.match).toBe(true);
            expect(ruleExecution2.skip).toBe(true);
            expect(ruleExecution2.executedAt).not.toBe(undefined);
            expect(ruleExecution2.targetId).toBe(undefined);
            expect(ruleExecution2.targetName).toBe(undefined);
            expect(ruleExecution2.targetSuccess).toBe(undefined);
            expect(ruleExecution2.targetStatusCode).toBe(undefined);
            ...
            expect(ruleExecution3.ruleId).toBe(rule1.id);
            expect(ruleExecution3.ruleName).toBe(rule1.name);
            ...
            expect(ruleExecution3.targetId).toBe(target1.id);
            expect(ruleExecution3.targetName).toBe(target1.name);
            expect(ruleExecution3.targetSuccess).toBe(true);
            expect(ruleExecution3.targetStatusCode).toBe(200);
            ...
            expect(ruleExecution4.ruleId).toBe(rule2.id);
            expect(ruleExecution4.ruleName).toBe(rule2.name);
            ...
            expect(ruleExecution4.targetId).toBe(target2.id);
            expect(ruleExecution4.targetName).toBe(target2.name);
            expect(ruleExecution4.targetSuccess).toBe(true);
            expect(ruleExecution4.targetStatusCode).toBe(202);
